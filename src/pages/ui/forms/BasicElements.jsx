          ...
          <Col lg={6}>
            <form onSubmit={handleSubmit(() => {})}>
              ...
              <Form.Group className="mb-0">
                <Form.Label htmlFor="example-helping" className="form-label">
                  Helping text
                </Form.Label>
                <Form.Control
                  type="text"
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <h6 className="font-15 mt-3">Disabled</h6>
        <div className="mt-2">
          <Form.Check
            defaultChecked
            disabled
        ...
        <h6 className="font-15 mt-3">Colors</h6>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <div>
          <h6 className="font-15 mt-3">Radios</h6>
          <div className="mt-3">
            <Form.Check
              type="radio"
              id="customRadio1"
    ...
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          ...
          <code>.col-form-label</code> to your <code>&lt;label&gt;</code>s as
    ...
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          ...
          <code>.align-items-center</code> class to display a series of labels,
          form controls, and buttons on a single horizontal row. Form controls
          within inline forms vary slightly from their default states. Controls
          only appear inline in viewports that are at least 576px wide to
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          By adding <code>.row</code> & <code>.g-2</code>, you can have control
        ...
        <Form>
          ...
          <Form.Group className="mb-2" id="formGridCheckbox3">
            <Form.Check
              type="checkbox"
              label="Check this custom checkbox"
              id="customcheckbox-1"
