  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Examples of custom modals.</p>
        <div className="d-flex flex-wrap gap-2">
    ...
    <Card>
      <Card.Body>
        ...
        <div className="d-flex flex-wrap gap-2">
          ...
          <Button
            variant="warning"
            onClick={() => openModalWithClass("bg-warning")}
          >
            Warning Alert
          </Button>
          <Button
            variant="danger"
            onClick={() => openModalWithClass("bg-danger")}
          >
            Danger Alert
          </Button>
        </div>
        <Modal className="fade" show={isOpen} onHide={toggleModal} size="sm">
          <div className={`modal-filled ${className}`}>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        >
          <Modal.Header
            className={`modal-colored-header bg-${className}`}
            closeButton
            closeVariant="white"
          >
    ...
    <Card>
      <Card.Body>
        ...
        <div className="d-flex flex-wrap gap-2">
          ...
          <Button variant="dark" onClick={() => openModalWithClass("bg-dark")}>
            Dark Filled
          </Button>
        </div>
        <Modal show={isOpen} onHide={toggleModal} className="fade">
          <div className={`modal-filled ${className}`}>
            <Modal.Header onHide={toggleModal} closeButton closeVariant="white">
              <Modal.Title as="h4">
                {className.charAt(3).toUpperCase() + className.slice(4)} Filled
                Modal
              </Modal.Title>
            </Modal.Header>
            <Modal.Body>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <Modal show={isOpen} onHide={toggleModal} tabIndex={-1}>
...
const Modals = () => {
  return (
    <>
      <PageBreadcrumb title="Modals" name="Modals" subName="Base UI" />
